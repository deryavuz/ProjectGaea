...
import { useState, useRef, useEffect, useContext, useMemo, useImperativeHandle, forwardRef } from 'react';
...
const StaticMap = forwardRef((props, ref) => {
  ...
  useEffect(() => {
    ...
    const mapbox = new Mapbox(_objectSpread(_objectSpread({}, props), {}, {
      mapboxgl,
      width: size[0],
      height: size[1],
  ...
  useImperativeHandle(ref, useMemo(() => getRefHandles(map), [map]));
